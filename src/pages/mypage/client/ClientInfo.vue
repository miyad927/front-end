                    ...
                    <td>
                      ...
                      <div class="btn_common_box">
                        <span class="btn_gray_list">
                          <a href="#memberNewPw" class="btn_gray_mid"> <em>비밀번호 설정</em><span class="arrow">▼</span> </a>
                        </span>
                        <span class="btn_gray_list">
                          <a href="#lyMemberPw" class="btn_gray_mid"> <em>비밀번호 도움말</em><span class="arrow">▼</span> </a>
                        </span>
                      </div>
                      ...
                      <div id="lyMemberPw" class="layer_area" v-show="isPasswordHelpVisible">
                        <div class="ly_wrap pw_advice_layer">
                          ...
                          <a href="#lyMemberPw" class="ly_close" @click="togglePasswordHelp">
                            <img src="https://thenaum.cdn-nhncommerce.com/data/skin/front/moment/img/common/layer/btn_layer_close.png" alt="닫기" />
                          </a>
                        </div>
                      </div>

                      <!-- 비밀번호 설정-->
                      <table id="memberNewPw" class="member_pw_change" v-show="isPasswordChangeVisible">
                        <tbody>
                          <tr>
                            <td>
