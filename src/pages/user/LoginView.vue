...
.member_login_box button.btn_submit {
  height: 3.5rem;
...
.member_cont .btn_login_box button {
  display: inline-block;
  font-size: 0.875rem;
...
.member_cont .btn_login_box li:not(:last-child):after {
  content: "";
  display: block;
  width: 0.0625rem;
  height: 0.75rem;
